...
#define DOOR_MAX					(4)				// ドアMAX
#define DOOR_MOVE_SPEED				(4.0f)			// ドアの移動速度

#define	QUARTER_SCREEN_X 			(SCREEN_WIDTH / 4)	// 横スクリーンの1/4
#define	QUARTER_SCREEN_Y 			(SCREEN_HEIGHT / 4)	// 縦スクリーンの1/4

#define	TRANSITION_TIME 			(60.0f)			// トランジション時間
...
static char *g_TexturName[TEXTURE_MAX] = {
	"data/TEXTURE/Menu/fade_black.png",
	"data/TEXTURE/Menu/fade_white.png",
	"data/TEXTURE/Menu/MarcoTransition0.png",
	"data/TEXTURE/Menu/MarcoTransition1.png",
	"data/TEXTURE/Menu/MarcoTransition2.png",
	"data/TEXTURE/Menu/MarcoTransition3.png",
};
