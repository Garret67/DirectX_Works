...
void InitCamera(void)
{
	...
	// ビューポートタイプの初期化
	g_ViewPortType = /*TYPE_FULL_SCREEN*/TYPE_RIGHT_HALF_SCREEN; 
}
...
void SetCamera(void) 
{
	...
	case TYPE_RIGHT_HALF_SCREEN:
		mtxProjection = XMMatrixPerspectiveFovLH(VIEW_ANGLE, /*VIEW_ASPECT*/(float)(SCREEN_WIDTH / 2.0f) / (float)SCREEN_HEIGHT, VIEW_NEAR_Z, VIEW_FAR_Z);
		break;
