...
// マクロ定義
//*****************************************************************************
#define SCREEN_WIDTH	(1280)/*(1280)*/			// ウインドウの幅		1920×1080	1280×720	960×540
#define SCREEN_HEIGHT	(720)/*(720)*/			// ウインドウの高さ
...
enum
{
	MODE_TITLE = 0,		// タイトル			画面
	MODE_MENU,			// メニュー			画面
	MODE_TUTORIAL_1,	// チュートリアル１	画面
	MODE_TUTORIAL_2,	// チュートリアル２	画面
	MODE_COLISEUM,		// コロシアム		画面
